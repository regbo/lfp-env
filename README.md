...
```sh
eval "$(curl -fsSL https://raw.githubusercontent.com/regbo/lfp-pixi/main/pixi-init.sh | sh)"
```

Windows install:

```powershell
powershell -ExecutionPolicy Bypass -c "irm -useb https://raw.githubusercontent.com/regbo/lfp-pixi/main/pixi-init.ps1 | iex"
```
...
```sh
eval "$(curl -fsSL https://raw.githubusercontent.com/regbo/lfp-pixi/main/pixi-init.sh | sh -s -- jq yq)"
```
...
```powershell
powershell -ExecutionPolicy Bypass -c "& ([scriptblock]::Create((irm -useb 'https://raw.githubusercontent.com/regbo/lfp-pixi/main/pixi-init.ps1'))) jq yq"
```
...
```powershell
powershell -ExecutionPolicy Bypass -c "& ([scriptblock]::Create((irm -useb 'https://raw.githubusercontent.com/regbo/lfp-pixi/main/pixi-init.ps1'))) -NoPersistUserEnv"
```
